...
class SecondeChanceSpider(scrapy.Spider):
    name = 'SecondeChance'
    allowed_domains = ['/www.secondechance.org']
    start_urls = ['https://www.secondechance.org/']

    def __init__(self, person=None, *args, **kwargs):
        super(SecondeChanceSpider, self).__init__(*args, **kwargs)
        self.person = person
